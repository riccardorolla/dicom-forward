...
$serviceDisplayName = $conf.displayName 
$ServiceDescription = $conf.description 
...
$installDir = $PSScriptRoot  # Where to install the service files
$scriptCopy = "$installDir\$scriptName"
$exeName = "$serviceName.exe"
$exeFullName = "$installDir\$exeName"
$logDir = "$PSScriptRoot\Logs"          # Where to log the service messages
